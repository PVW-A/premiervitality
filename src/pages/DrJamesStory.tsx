      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="space-y-6 text-muted-foreground font-body font-light text-sm leading-relaxed">
            ...
            <p>
              That curiosity followed me into medical school, where I kept digging into neuroplasticity research. I wanted to understand what happens when the brain's ability to adapt gets disrupted — and more importantly, what we could do about it.
            </p>
            <p>
              That work naturally led me into addiction medicine. When you study how the brain rewires itself, you start to see addiction differently. It's not a character flaw. It's a brain that got stuck in a loop, and the science of neuroplasticity gave me real tools to help people find their way out. I got board-certified in addiction medicine because the research pointed me there, and the patients needed someone who understood the why behind it.
            </p>
            <p>
              Along the way, I also became board-certified in family practice. I wanted to take care of the whole person, not just one piece of the puzzle. Families, kids, grandparents — the full picture. That's always been important to me.
            </p>
            <p>
